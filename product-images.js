function productImage(name=''){
  ...
  if(n.includes('قرما اند مدوندونق')||n.includes('grim and mondongo')||n.includes('grim')&&n.includes('mondongo'))return 'https://yumcut.com/brainrot-data/mieteteira-bicicleteira/preview/profile.webp';
