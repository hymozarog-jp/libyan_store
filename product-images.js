function productImage(name=''){
  ...
  if(n.includes('قرما اند مدوندونق')||n.includes('garama and madundung')||n.includes('garama')&&n.includes('madundung'))return 'https://yumcut.com/brainrot-data/garama-and-madundung/original/empty.webp';
